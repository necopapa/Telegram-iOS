...
{
    if (_phoneId == 0)
        _phoneId = phoneMatchHash([TGStringUtils cleanPhone:_number]);
...
- (bool)isEqualToPhoneNumberFuzzy:(TGPhoneNumber *)other
{
    ...
    if ((_number != nil) != (other.number != nil) || (_number != nil && ![[TGStringUtils cleanPhone:_number] isEqualToString:[TGStringUtils cleanPhone:other.number]]))
        return false;
