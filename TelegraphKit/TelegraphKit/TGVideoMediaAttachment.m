...
- (BOOL)isEqual:(id)object
{
    ...
    if ((_videoInfo == nil) != (other.videoInfo != nil) || (_videoInfo != nil && ![_videoInfo isEqual:other.videoInfo]))
        return false;
    
    if ((_thumbnailInfo == nil) != (other.thumbnailInfo != nil) || (_thumbnailInfo != nil && ![_thumbnailInfo isEqual:other.thumbnailInfo]))
        return false;
