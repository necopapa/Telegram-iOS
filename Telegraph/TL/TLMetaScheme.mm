...
void TLRegisterClasses()
{
    ...
    TLMetaClassStore::registerObjectClass([TLDecryptedMessage$decryptedMessageForwarded new]);
    ...
    TLMetaClassStore::registerObjectClass([TLDecryptedMessageMedia$decryptedMessageMediaFile new]);
