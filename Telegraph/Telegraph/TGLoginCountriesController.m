...
- (void)loadView
{
    ...
    if (_sections == nil)
    {
        ...
        UIImage *sectionHeaderBackground = [UIImage imageNamed:@"CategoryDivider.png"];
        UIImage *sectionHeaderBackgroundFirst = [UIImage imageNamed:@"CategoryDividerFirst.png"];
        ...
        for (TGCountrySection *section in _sections)
        {
            ...
            sectionView.image = index == 0 ? sectionHeaderBackgroundFirst : sectionHeaderBackground;
            [sectionContainer addSubview:sectionView];
            
            UILabel *sectionLabel = [[UILabel alloc] init];
            sectionLabel.font = labelFont;
            ...
            section.headerView = sectionContainer;
