...
- (void)drawRect:(CGRect)__unused rect
{
    ...
    [_titleSecond drawInRect:CGRectMake(_titleOffset.x + titleFirstSize.width + 4, _titleOffset.y, size.width - (_titleOffset.x + titleFirstSize.width + 4), titleFirstSize.height) withFont:titleSecondFont];
