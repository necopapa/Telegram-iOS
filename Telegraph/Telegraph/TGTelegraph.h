...
@class TGConversationSendMessageActor;
...
- (NSObject *)doSignUp:(NSString *)phoneNumber phoneHash:(NSString *)phoneHash phoneCode:(NSString *)phoneCode firstName:(NSString *)firstName lastName:(NSString *)lastName emailAddress:(NSString *)emailAddress requestBuilder:(TGSignUpRequestBuilder *)requestBuilder;
...
- (NSObject *)doConversationSendMessage:(int64_t)conversationId messageText:(NSString *)messageText geo:(TLInputGeoPoint *)geo messageGuid:(NSString *)messageGuid tmpId:(int64_t)tmpId actor:(TGConversationSendMessageActor *)actor;
- (NSObject *)doConversationSendMedia:(int64_t)conversationId media:(TLInputMedia *)media messageGuid:(NSString *)messageGuid tmpId:(int64_t)tmpId actor:(TGConversationSendMessageActor *)actor;
