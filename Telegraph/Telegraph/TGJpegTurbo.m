...
UIImage *TGJpegTurboDecode(NSData *data)
{
    if (true)
    {
        NSDictionary *dict = [[NSDictionary alloc] initWithObjectsAndKeys:(id)kCFBooleanTrue, (id)kCGImageSourceCreateThumbnailWithTransform, (id)kCFBooleanTrue, (id)kCGImageSourceCreateThumbnailFromImageIfAbsent, (id)[NSNumber numberWithDouble:960], (id)kCGImageSourceThumbnailMaxPixelSize, nil];
        CGImageSourceRef source = CGImageSourceCreateWithData((__bridge CFDataRef)data, nil);
        if (source != nil)
        {
            CGImageRef cgImage = CGImageSourceCreateImageAtIndex(source, 0, (__bridge CFDictionaryRef)dict);
            
            UIImage *dataImage = [UIImage imageWithCGImage:cgImage];
